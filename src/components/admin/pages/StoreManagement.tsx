    ...
    try {
        ...
        .insert([
          {
            ...
            business_hours: (newStore as any).businessHours || null,
            reception_hours: (newStore as any).receptionHours || null,
            image_url: imageUrl,
      ...
      if (data && data.length > 0) {
        ...
        const mapped: Store = {
          ...
          phone: created.phone || '',
          businessHours: created.business_hours || '',
          receptionHours: created.reception_hours || '',
