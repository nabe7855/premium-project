...
export default function HeroSection() {
  ...
  const handleViewCastsClick = () => {
    requireAgeVerification(() => {
      // ここに実際のアクション（キャスト一覧ページへの遷移など）を実装
        ...
        <div className="relative z-10 flex flex-col justify-center min-h-screen px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center mb-6">
              <Badge variant="secondary" className="bg-white/80 text-rose-700 px-4 py-2 text-sm font-medium">
