  ...
  return (
    <div className="space-y-4">
      ...
      {diagnosisResult && !isDiagnosticMode && (
        <div className="relative rounded-2xl border border-pink-100 bg-gradient-to-br from-pink-50 to-white p-5 shadow-sm animate-in fade-in slide-in-from-top-2">
          <button 
          ...
          <div className="mb-2 flex items-center gap-2 text-sm font-bold text-pink-600">
            <Sparkles className="h-5 w-5 fill-pink-600" />
            あなたの顔タイプは「{diagnosisResult.faceType}」タイプ！
          </div>
      ...
      <div className="flex flex-col gap-2">
        <span className="text-xs text-gray-500">手動で選択・変更する：</span>
        <div className="flex flex-wrap gap-2">
          {faceOptions.map((opt) => {
