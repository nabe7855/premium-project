  ...
  const faqItems: FAQItem[] = [
    {
      ...
      answer:
        'はい、未経験の方も大歓迎です。充実した研修制度があり、先輩セラピストがマンツーマンでサポートします。8割以上の方が未経験からスタートしています。',
    },
    {
      category: 'プライバシー',
      question: '身バレや顔バレの心配はありませんか？',
      answer:
        '完全個室制度により、他のお客様や従業員と顔を合わせることはありません。また、顔出しは一切不要で、個人情報の管理も徹底しています。',
    },
    {
      category: '勤務について',
    ...
    },
    {
      ...
      answer:
        '女性スタッフが中心となって、温かく支え合う職場環境を作っています。定期的な交流イベントもあり、仲間との絆も深められます。',
    },
  ];
