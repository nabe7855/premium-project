...
export default function DiarySection() {
  ...
  // Data will be empty if not loaded or no DB entries
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {diaries.length > 0 ? (
            ...
            <div className="col-span-full flex w-full items-center justify-center py-20 text-center">
              <p className="font-serif text-lg tracking-[0.3em] text-gray-300">日記準備中</p>
            </div>
          )}
        </div>
