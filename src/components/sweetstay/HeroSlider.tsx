...
const DEFAULT_BANNERS = [
  {
    id: 'default-1',
    image_url: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80&w=1600',
    title: '至福のひとときを、',
    subtitle: '選び抜かれた大人の隠れ家。',
  },
  {
    id: 'default-2',
    image_url: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&q=80&w=1600',
    title: 'プロが選ぶ安心感。',
    subtitle: '現役セラピスト推奨の極上空間。',
  },
  {
    id: 'default-3',
    image_url: 'https://images.unsplash.com/photo-1544124499-58912cbddadf?auto=format&fit=crop&q=80&w=1600',
    title: '日常を忘れる贅沢。',
...
const HeroSlider: React.FC<HeroSliderProps> = ({ banners }) => {
  ...
  const nextSlide = () => setIndex((prev) => (prev + 1) % currentBanners.length);
  const prevSlide = () => setIndex((prev) => (prev - 1 + currentBanners.length) % currentBanners.length);
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="relative aspect-[16/8] w-full overflow-hidden rounded-[2.5rem] bg-rose-50 shadow-xl md:aspect-[21/9]">
          <AnimatePresence mode="wait">
            ...
            >
              <Image
                src={currentBanners[index].image_url}
                alt={currentBanners[index].title}
                fill
        ...
        <div className="flex items-end justify-between px-2">
          ...
          <div className="flex flex-col gap-1">
            <motion.span
              key={`tag-${currentBanners[index].id}`}
