      ...
      */}
      ...
      <AnimatePresence>
        {(isVerified === false || isVerified === null) && (
          <motion.div
            initial={isVerified === null ? { opacity: 1 } : { opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[99999] flex items-center justify-center bg-white p-4 backdrop-blur-xl"
            style={{
          ...
          >
            <motion.div
              initial={isVerified === null ? { scale: 1, y: 0, opacity: 1 } : { scale: 0.9, y: 20, opacity: 0 }}
