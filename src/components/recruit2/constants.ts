export const STOCK_RECRUIT_CONFIG = {
  ...
  fukuoka: {
    ...
    heading: 'あなたと福岡で\n挑戦したい理由',
    description1:
      '博多エリアは、女性用風俗市場が急成長している街。「自分を変えたい」「本気で高収入を目指したい」そう願う男性が集まる場所だから、私たちは福岡を選びました。\n東京で培った育成ノウハウと、博多の勢いを掛け合わせ、未経験からでも成功できる環境を整えています。あなたの挑戦を、私たちは全力で支えます。',
  ...
  trust: {
    ...
    statsHeaderTitle: 'なぜ、8年も選ばれ続けるのか',
    statsHeaderDesc: '数字が証明する、私たちの実績。',
    stats: [
      {
        label: '継続年数',
        value: '8',
