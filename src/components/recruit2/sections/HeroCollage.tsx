        ...
        <motion.div variants={itemVariants} className="relative z-20 w-full text-center">
          {isEditing ? (
            <h1
              ...
              className="mb-6 cursor-text break-words w-full max-w-full rounded font-serif text-3xl font-bold leading-[1.2] tracking-tight text-white outline-none drop-shadow-md hover:bg-white/10 sm:text-5xl sm:leading-tight md:text-6xl lg:text-7xl"
              style={{ whiteSpace: 'pre-line' }}
            >
              {mainHeading}
            </h1>
          ) : mainHeading === 'ただ「稼ぐ場所」ではなく\n“価値ある男”としてゼロから稼げる場所。' ? (
            <h1 className="mb-6 break-words w-full max-w-full font-serif text-3xl font-bold leading-[1.2] tracking-tight text-white sm:text-5xl sm:leading-tight md:text-6xl lg:text-7xl">
            ...
            <h1
              className="mb-6 break-words w-full max-w-full font-serif text-3xl font-bold leading-[1.2] tracking-tight text-white sm:text-5xl sm:leading-tight md:text-6xl lg:text-7xl"
              style={{ whiteSpace: 'pre-line' }}
            >
              {mainHeading}
            </h1>
        ...
        <motion.div variants={itemVariants} className="relative z-20 w-full text-center">
          {isEditing ? (
            <p
              ...
              className="mx-auto mb-10 max-w-3xl w-full max-w-full break-words cursor-text rounded px-2 text-base leading-relaxed text-slate-300 outline-none hover:bg-white/10 sm:text-xl md:text-2xl"
              style={{ whiteSpace: 'pre-line' }}
            >
              {subHeading}
            </p>
            ...
            '今日からでも、人生は変えられる。\n数多くの未経験者をプロに導いた、創業8年の信頼と実績。' ? (
            <p className="mx-auto mb-10 max-w-3xl w-full max-w-full break-words px-2 text-base leading-relaxed text-slate-300 sm:text-xl md:text-2xl">
              今日からでも、人生は変えられる。
              <br className="hidden sm:block" />
              数多くの未経験者をプロに導いた、創業8年の信頼と実績。
            </p>
            ...
            <p
              className="mx-auto mb-10 max-w-3xl w-full max-w-full break-words px-2 text-base leading-relaxed text-slate-300 sm:text-xl md:text-2xl"
              style={{ whiteSpace: 'pre-line' }}
            >
              {subHeading}
            </p>
        ...
        >
          ...
          >
            <span className="relative z-10 flex flex-col items-center leading-snug">
              <span className="text-sm sm:text-base">履歴書不要！</span>
              <span>30秒で簡単応募！</span>
            </span>
