        ...
        <div className="-mx-4 px-4 pb-8 sm:mx-0 sm:px-0">
          <div className="grid grid-cols-[70px_1fr_1fr_1fr] items-stretch gap-1 text-center sm:grid-cols-[120px_1fr_1fr_1fr] sm:gap-4">
            ...
            <div className="relative col-span-1">
              <div className="absolute -left-1 -right-1 -top-2 bottom-0 z-0 origin-bottom scale-y-105 transform rounded-t-xl bg-blue-600 shadow-lg sm:-left-2 -right-2 sm:-top-4 sm:scale-y-110 sm:rounded-t-2xl sm:shadow-xl" />
              <div className="relative z-10 flex h-full flex-col items-center justify-center -mt-1 px-1 py-3 text-white sm:-mt-2 sm:px-4 sm:py-6">
                <h4 
