      ...
      <div className="mx-auto flex h-[58px] max-w-7xl items-center justify-between px-4 md:h-[72px] md:px-6">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <button
            ...
            className={`flex flex-shrink-0 flex-col items-center justify-center gap-1 rounded-full px-4 py-2.5 transition-all active:scale-95 md:gap-1.5 md:px-5 md:py-3.5 ${
              isMenuOpen
                ...
                <div className="relative z-10 mx-auto max-w-md space-y-6 px-5">
                  ...
                  <div className="overflow-hidden rounded-[40px] bg-neutral-900 shadow-2xl transition-transform active:scale-[0.98]">
                    ...
                    >
                      ...
                      <NextImage
                        src={getAbsoluteHref(
                          config.specialBanner?.imageUrl || '/福岡募集バナー.png',
                        )}
                        alt="Special Banner"
                        fill
