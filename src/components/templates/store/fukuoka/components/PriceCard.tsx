    ...
    >
      ...
      <div className={`bg-[#642B2B] py-4 text-center`}>
        <h3
          ...
          className="text-xl font-black tracking-[0.2em] text-white outline-none"
        >
          {title}
        </h3>
      </div>
      ...
      <div className="p-8">
        ...
        <p
          ...
          suppressContentEditableWarning
          className="mb-8 text-sm font-bold leading-relaxed text-[#642B2B]/80 md:text-base outline-none"
        >
          {description}
        </p>
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-baseline gap-1 text-[#642B2B]">
                  ...
                  <span
                    ...
                    suppressContentEditableWarning
                    className="text-3xl font-black tabular-nums outline-none"
                  >
