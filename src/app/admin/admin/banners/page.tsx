  ...
  return (
    <div className="p-2 md:p-0">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 flex flex-wrap gap-4 rounded-2xl border border-gray-700/50 bg-brand-secondary p-4 shadow-lg">
          <div className="flex items-center gap-2">
            <Filter className="h-4 w-4 text-gray-500" />
            <span className="text-sm font-medium text-gray-400">フィルタ:</span>
          </div>
          <select
            value={filterCategory}
            onChange={(e) => setFilterCategory(e.target.value)}
            className="rounded-lg border border-gray-600 bg-brand-primary px-3 py-1.5 text-xs text-white outline-none focus:border-brand-accent"
          >
          ...
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-gray-700 bg-brand-secondary p-8 shadow-2xl">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-1 flex justify-center rounded-lg border border-dashed border-gray-600 px-6 py-10 hover:bg-gray-800/50">
                  {formData.imageUrl ? (
                    <div className="relative w-full text-center">
                      <img src={formData.imageUrl} alt="Preview" className="mx-auto h-48 w-full object-contain mb-4" />
                      <button onClick={() => { setFormData({ ...formData, imageUrl: '' }); setSelectedFile(null); }} className="text-red-400 text-sm font-semibold">
                        画像を削除
                      </button>
                    </div>
                  ) : (
                    <div className="text-center">
                      ...
                      <label htmlFor="file-upload" className="cursor-pointer text-brand-accent text-sm font-bold block mt-4">
                        画像をアップロード
