...
export const DEFAULT_STORE_TOP_CONFIG: StoreTopPageConfig = {
  ...
  faq: {
    ...
    items: [
      ...
      {
        id: '5',
        question: '容姿に自信がないし、年齢差もあるので利用していいか迷っています。',
        answer:
          'ストロベリーボーイズをご利用くださるお客様は、年齢も容姿も本当に様々です。セラピストはあなたを評価する立場ではなく、あなたをいたわるためにいる存在です。安心してご自分の「癒やされたい」という気持ちだけを大切にお越しください。',
      },
      {
        id: '6',
  ...
  footer: {
    ...
    menuButtons: [
      ...
      { label: '求人募集', link: '/store/{slug}/recruit' },
    ...
    bottomNav: [
      ...
      { label: '電話', icon: 'PhoneCall', href: 'tel:{phone}', color: 'text-slate-600', isVisible: true },
