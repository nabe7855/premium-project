...
export const DEFAULT_FIRST_TIME_CONFIG: FirstTimeConfig = {
  ...
  sevenReasons: {
    ...
    reasons: [
      {
        title: '透明性を重視したリアルな口コミ掲載！',
        desc: 'お店の雰囲気を感じてもらうためHP内にお客様の口コミ欄をご用意。リアルな声が投稿されており、利用の参考にしていただけます。',
      },
      {
      ...
      },
      {
        ...
        desc: 'フランチャイズとは違い、全国展開している店舗は全て直接運営に携わったスタッフが管理。どの地域でも安定のおもてなしを提供します。',
      },
      {
        title: '定期的な性病検査の義務付け！',
      ...
      {
        title: '安心のおもてなしと信頼のサポート体制！',
        desc: '急速に成長する業界で、当店はお客様一人ひとりの気持ちに寄り添い、安心・丁寧な女風デビューをサポートし続けています。',
      },
    ],
    isVisible: true,
  },
