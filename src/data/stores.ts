...
export const stores: Record<string, Store> = {
  ...
  tokyo: {
    ...
    colors: {
      primary: 'tokyo-500',
      secondary: 'tokyo-300',
      gradient: 'bg-gradient-tokyo',
    },
    seo: {
      title:
        '【ストロベリーボーイズ東京】心とろける極上のひととき｜甘くとろける癒しのイケメン派遣｜本日出勤あり',
      description:
        '東京で最高品質のエンターテインメントサービス。心とろける極上のひとときをお約束します。本日出勤キャスト多数、ご予約受付中。',
    },
  },
  osaka: {
    id: 'osaka',
    ...
    colors: {
      primary: 'osaka-500',
      secondary: 'osaka-300',
      gradient: 'bg-gradient-osaka',
    },
    seo: {
      title:
        '【ストロベリーボーイズ大阪】え、やばい。こんな楽しいの反則やん。｜心ときめくイケメン派遣サービス｜梅田・難波エリア',
      description:
        '大阪梅田・難波エリアで最高のエンターテインメント。心ときめく極上の遊びをご提供します。今すぐご予約を。',
    },
  },
  nagoya: {
    id: 'nagoya',
...
*/
  fukuoka: {
    ...
    seo: {
      ...
      description:
        '福岡（博多・天神・中洲・薬院）で女性用風俗・女風・出張ホストをお探しならストロベリーボーイズ福岡店。厳選されたイケメンセラピストがご指定ホテルやご自宅で最高級の癒やしをお届け。明朗会計・初心者歓迎・当日予約OK！',
    },
  },
  yokohama: {
    id: 'yokohama',
    ...
    seo: {
      ...
      description:
        '横浜（みなとみらい・関内・桜木町・新横浜）で女性用風俗・女風・出張ホストをお探しならストロベリーボーイズ横浜店。洗練された人気セラピストがご指定ホテル・ご自宅へ出張。完全個室・安心明朗会計・初めての方も丁寧サポート！',
    },
  },
};
