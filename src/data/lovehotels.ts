import { FeatureArticle, Hotel, Prefecture, Review } from '@/types/lovehotels';
...
export const PREFECTURES: Prefecture[] = [
  ...
  },
  {
    ...
    name: '神奈川県',
    count: 98,
    cities: [{ id: 'yokohama', name: '横浜市', count: 30, areas: ['新横浜', '関内'] }],
  },
];
...
export const MOCK_HOTELS: Hotel[] = [
  ...
  },
  {
    ...
    imageUrl:
      'https://images.unsplash.com/photo-1582719478237-c26ad0c9a0d6?auto=format&fit=crop&q=80&w=800',
    minPriceRest: 5000,
    minPriceStay: 11000,
    rating: 4.7,
    reviewCount: 92,
...
export const MOCK_FEATURES: FeatureArticle[] = [
  ...
  },
  {
    ...
    `,
    imageUrl:
      'https://images.unsplash.com/photo-1590447158019-883d8d5f8bc7?auto=format&fit=crop&q=80&w=800',
    date: '2024.05.28',
    tags: ['福岡', '中洲', '夜景'],
    relatedHotelIds: ['f1'],
  },
